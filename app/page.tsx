...
export default async function Home() {
  ...
  return (
    <PublicShell>
      ...
      <section className="section shell"><div className="relationship"><div className="relationship-mark"><Image src="/brand/betts-works-full-badge-dark.png" width={460} height={392} alt="Betts Works — Australian owned car dealer" /></div><div><p className="eyebrow">Two specialist roles</p><h2>Betts Works sells. SCD Direct supplies.</h2><p>{siteConfig.relationship}</p><p className="legal-line">Each Betts Works listing retains the matching SCD Direct stock number, source photography, vehicle details and price basis.</p><a className="button button-secondary" href="https://scddirect.com.au/vehicle-inventory/" target="_blank" rel="noopener noreferrer">View SCD inventory <span aria-hidden="true">↗</span></a></div></div></section>
