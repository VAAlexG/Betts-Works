  ...
  return (
    <PublicShell>
      ...
      <article className="section shell prose">
        ...
        <p>Links to SCD Direct, the specialist right-hand-drive conversion provider, and other providers are supplied for context. Betts Works and SCD Direct have distinct roles described on this website. Third-party websites, conversion, transport, finance, insurance and other services are governed by their own terms.</p>
